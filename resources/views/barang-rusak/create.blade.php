                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="lokasi" class="form-select" id="lokasiSelect" required onchange="toggleRuangan()">
                            <option value="dalam_ruangan" {{ old('lokasi') == 'dalam_ruangan' ? 'selected' : '' }}>Dalam
                                Ruangan</option>
                            <option value="luar_ruangan" {{ old('lokasi') == 'luar_ruangan' ? 'selected' : '' }}>Luar Ruangan
                            </option>
                        </select>
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="date" name="tanggal_rusak" class="form-control"
                            value="{{ old('tanggal_rusak', date('Y-m-d')) }}" required>
                    </div>
                    <div class="col-md-6 mb-3">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="jenis_kerusakan" class="form-control" value="{{ old('jenis_kerusakan') }}"
                            required>
                    </div>
                    <div class="col-md-6 mb-3">
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <textarea name="deskripsi_kerusakan" class="form-control"
                            rows="3">{{ old('deskripsi_kerusakan') }}</textarea>
                    </div>
                </div>
