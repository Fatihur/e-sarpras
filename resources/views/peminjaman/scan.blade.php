        ...
        if (data.success) {
            ...
            document.getElementById('hasilScan').innerHTML = `
                ...
                <div class="d-flex flex-wrap gap-2">
                    ${b.status_barang === 'aktif' 
                        ? `<a href="{{ route('peminjaman.create') }}?barang_id=${b.id}" class="btn btn-primary"><i class="bi bi-arrow-left-right me-1"></i>Pinjam Barang Ini</a>` 
                        : '<div class="alert alert-warning mb-0 flex-grow-1"><i class="bi bi-exclamation-triangle me-1"></i>Barang tidak tersedia untuk dipinjam</div>'}
