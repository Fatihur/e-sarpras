...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <a href="{{ route('barang-keluar.index') }}" class="btn btn-secondary"><i class="bi bi-arrow-left me-1"></i>Kembali</a>
</div>
<div class="card">
    <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select name="barang_id" class="form-select @error('barang_id') is-invalid @enderror" required>
                        ...
                        @foreach($barang as $b)
                        <option value="{{ $b->id }}" {{ old('barang_id') == $b->id ? 'selected' : '' }}>{{ $b->kode_barang }} - {{ $b->nama_barang }} (Stok: {{ $b->jumlah }})</option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <select name="alasan_keluar" class="form-select" required>
                        ...
                        <option value="Dihibahkan" {{ old('alasan_keluar') == 'Dihibahkan' ? 'selected' : '' }}>Dihibahkan</option>
                        <option value="Dimusnahkan" {{ old('alasan_keluar') == 'Dimusnahkan' ? 'selected' : '' }}>Dimusnahkan</option>
                        <option value="Dipindah" {{ old('alasan_keluar') == 'Dipindah' ? 'selected' : '' }}>Dipindah Permanen</option>
                    </select>
                </div>
                <div class="col-md-4 mb-3">
