    ...
    <div class="card-body">
        <form method="POST" action="{{ route('lahan.update', $lahan) }}">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="kode_lahan" class="form-control @error('kode_lahan') is-invalid @enderror" value="{{ old('kode_lahan', $lahan->kode_lahan) }}" required>
            ...
            <div class="mb-3">
                ...
                <input type="text" name="lokasi_lahan" class="form-control" value="{{ old('lokasi_lahan', $lahan->lokasi_lahan) }}">
            </div>
