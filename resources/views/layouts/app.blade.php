...
<body>
    ...
    <aside class="sidebar" id="sidebar">
        <div class="sidebar-header d-flex justify-content-between align-items-center">
            <h4 class="mb-0">
                <img src="{{ asset('images/logo.png') }}" alt="Logo e-Sarpras" style="height: 45px; width: auto;"
                    class="me-2">
                e-Sarpras
            </h4>
        ...
        <nav class="sidebar-nav">
            ...
            @if(auth()->user()->isAdmin() || auth()->user()->isManajemen())
                ...
                <a href="{{ route('barang-rusak.index') }}"
                    class="nav-link {{ request()->routeIs('barang-rusak.*') ? 'active' : '' }}">
            ...
            <a href="{{ route('barang-ruangan.index') }}"
                class="nav-link {{ request()->routeIs('barang-ruangan.*') ? 'active' : '' }}">
        ...
        <nav class="top-navbar">
            ...
            <div class="d-flex align-items-center gap-3">
                ...
                <form action="{{ route('logout') }}" method="POST" class="d-inline">
                    @csrf
                    <button type="submit" class="btn btn-outline-danger btn-sm"><i class="bi bi-box-arrow-right"></i>
                        Logout</button>
                </form>
            </div>
        </nav>
